                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-target="#subcategories{{$loop->iteration}}">
                                        @if(count($category->children))<span class="badge pull-right"><i class="fa fa-plus"></i></span>@endif
                                        {{$category->name}}
                                    </a>
                                </h4>
                            </div>
                                ...
                                <div class="panel-body">
                                    <ul>
                                        @foreach($category->children as $subCategory)
                                            <li><a href="{{route('search_by_category',['id'=>$subCategory->id])}}">{{$subCategory->name}} ({{count($subCategory->products)}})</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
